...
namespace _36Demo_CSharpFeatures
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // When database/anyone: returns null value for value type containers
            // of C# (like int, double, bool, char, DateTime etc) then it will
            // create problem.Hence we need to create Nullable type
            // variables: Nullable<T> name = null;
            string name = null;
            //int deptID = null; // Compilation Error
            // int? deptID = null; // a vlaue type can hold null value if we
            ...
            // We can initialize objects while declaring it using {}
            // brackets, internally at backend - compiler will generate
            // combinations of overloaded constrctors syntaxes for us.
            // This will keep our class clean and readable.
